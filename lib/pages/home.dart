        ...
        child: Row(
            ...
            children: [
              ...
              GestureDetector(
                ...
                child: BottomBarItem(Icons.shopping_cart, "", isActive: activeTab == 2, activeColor: secondary),
              ),
              GestureDetector(
                onTap: () {
                  setState(() {
                ...
                child: BottomBarItem(Icons.book, "", isActive: activeTab == 3, activeColor: secondary),
              ),
              ...
              GestureDetector(
                ...
                child: BottomBarItem(Icons.settings, "", isActive: activeTab == 4, activeColor: secondary),
              )
            ]
          )
        ),
        ...
        child: Container(
          ...
          child: IndexedStack(
            ...
            children: <Widget>[
              ...
              Center(
                child: Text("الأعدادات",style: TextStyle(
                  fontSize: 35
                ),),
              )
            ],
